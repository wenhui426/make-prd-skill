...
PRD 初稿生成后，快速扫描哪些地方需要用户进一步补充和完善。这不是完整评审（完整评审在 STEP 3 质量审查），而是"生成后质量门禁"。

## 自检流程

### 第一步：重大风险项快扫（R1-R8）

逐项检查以下 8 个重大风险项，标注状态：
...
| --- | --- | --- | --- |
| 01 业务分析质量 | 第1章 | | |
| 02 产品类型适配性 | STEP 2 ① 开工定型确认 | | |
| 03 产品定位合理性 | 第2章 | | |
| 04 场景分析与用户旅程 | 第1章（承接产品规划 JTBD） | | |
| 05 文档结构完整性 | 全文 | | |
| 06 架构设计质量 | 第5.2节 | | |
| 07 数据建模质量 | 第5.2.2节 | | |
| 08 流程与角色设计 | 第5+7章 | | |
...
4. 最后提示用户：完善后可进入 **STEP 3 质量审查**，形成闭环。
