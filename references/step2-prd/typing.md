...
> 在 STEP 2 ① 开工定型确认后加载此文件，用于确定各章节的内容侧重和适用性调整。
...
- **第2章**：补充 SaaS 关键指标预估（CAC、LTV、MRR、Churn Rate），LTV/CAC > 3 为健康基线
- **第5章**：多租户架构设计（DB/Schema/Table/Row 级别隔离策略）
- **第5章**：配置化能力设计（参数配置、对象编辑器、流程编辑器）
- **可选 D**：种子客户策略 + 从项目制到产品化的演进路线
...
| 迭代/模块级需求 | 第1章简化为变更背景、第2章可省略商业分析、第3-4章聚焦变更范围、第5章聚焦变更模块、第7章只更新受影响的权限 |

### AI 功能相关

如果用户描述中涉及 AI 功能，在第5章中额外应用：
